...
!(function () {
    ...
    const t = {
        ...
        i = { upColor: "#26a69a", downColor: "#ef5350", openVisible: !0, thinBars: !0 },
        n = {
            color: "#2196f3",
            lineStyle: 0,
            lineWidth: 3,
    ...
    function V(t, i, n) {
        return void 0 === i && (i = z), `${(n = void 0 !== n ? `${n} ` : "")}${t}px ${i}`;
    }
    class E {
        constructor(t) {
            (this.k = { C: 1, T: 5, P: NaN, R: "", D: "", O: "", B: "", A: 0, V: 0, I: 0, L: 0, N: 0 }), (this.F = t);
        }
        W() {
            const t = this.k,
                i = this.j(),
    ...
    class $ {
        constructor(t) {
            (this.ft = !0),
                (this.Ft = { It: { et: 1, Nt: 0, O: "", kt: !1 }, Lt: { et: 1, Nt: 0, O: "", kt: !1 }, nt: 0, st: 0 }),
    ...
    function X(t, i, n, s, e, r, h = 0, l = [0, 0, 0, 0], a = "") {
        if ((t.save(), !h || !a || a === r)) return Y(t, i, n, s, e, l), (t.fillStyle = r), t.fill(), void t.restore();
        const o = h / 2;
        var _;
        Y(t, i + o, n + o, s - h, e - h, ((_ = -o), l.map((t) => (0 === t ? t : t + _)))),
            "transparent" !== r && ((t.fillStyle = r), t.fill()),
            "transparent" !== a && ((t.lineWidth = h), (t.strokeStyle = a), t.closePath(), t.stroke()),
            t.restore();
    }
    ...
    class Z {
        ...
        K(t, i, n, s) {
            ...
            const e = this.Et.O,
                ...
                h = t.useBitmapCoordinateSpace((t) => {
                    ...
                    return (
                        o(r, "transparent"),
                        this.Et.hi && ((h.fillStyle = e), h.fillRect(a.ri, a.li, a.ai - a.ri, a.oi)),
                        o("transparent", r),
                        this.Et._i && ((h.fillStyle = i.B), h.fillRect(l.Qt ? a.ui - a.ei : 0, a.ii, a.ei, a.ci - a.ii)),
                        l
                    );
                });
        ...
        Gt(t, i, n, s) {
            ...
            let z, V, E;
            return (
                O ? ((z = A - k), (V = A - C), (E = B - _ - f - u)) : ((z = A + k), (V = A + C), (E = B + _ + f)),
                {
                    Qt: O,
                    Jt: { ii: R, li: P, ci: D, ni: k, si: S, ht: 2 * a, ei: y, ti: z, ri: A, ai: V, oi: x, ui: h.width },
    ...
    class G {
        constructor(t) {
            (this.ki = { yi: 0, t: "#000", gi: 0, wi: 0 }),
                (this.Ci = { Zt: "", kt: !1, hi: !0, mi: !1, Bt: "", O: "#FFF", _i: !1, bi: !1 }),
                (this.Ti = { Zt: "", kt: !1, hi: !1, mi: !0, Bt: "", O: "#FFF", _i: !0, bi: !0 }),
                (this.ft = !0),
        ...
        Vi() {
            return this.Di(), this.Pi.J(this.Ci, this.ki), this.Ri.J(this.Ti, this.ki), this.Ri;
        }
        Di() {
            this.ft && ((this.Ci.hi = !0), (this.Ti.hi = !1), this.Ei(this.Ci, this.Ti, this.ki));
        }
    }
    class J extends G {
        constructor(t, i, n) {
    ...
    class tt {
        ...
        K(t, i) {
            ...
            const n = t.useMediaCoordinateSpace(({ context: t }) => ((t.font = i.R), Math.round(i.Wi.xi(t, f(this.Et).Zt, Q))));
            if (n <= 0) return;
            const s = i.ji,
                e = n + 2 * s,
                r = e / 2,
            ...
            a < 0
                ...
                : a + e > h && ((l -= Math.abs(h - (a + e))), (a = Math.floor(l - r) + 0.5));
            const o = a + e,
    ...
    class it {
        constructor(t, i, n) {
            (this.ft = !0),
                (this.Wt = new tt()),
                (this.Ft = { kt: !1, t: "#4c525e", O: "white", Zt: "", Hi: 0, yi: NaN, hi: !0 }),
                (this.vt = t),
                (this.$i = i),
                (this.Li = n);
        }
    ...
    class et extends nt {
        ...
        An(t, i, n) {
            const s = this.ln,
                ...
                l = this.tn,
                a = this.Bn(n);
            (this.sn = t), (this.ln = isNaN(t) ? NaN : this.$i.St().Vt(t)), (this.tn = n);
            const o = null !== a ? a.Ct() : null;
            return (
                null !== a && null !== o ? ((this.nn = i), (this.an = a.Rt(i, o))) : ((this.nn = NaN), (this.an = NaN)),
    ...
    class ot {
        ...
        ls(t) {
            ...
            if (i > 1) {
                ...
                r >= i && ((r -= i), (n += 1)), (s = lt + at(+r.toFixed(this.os) * this.rs, e));
    ...
    class ut {
        ...
        us(t) {
            ...
            return (
                (i = (t = Math.round(t * n) / n) >= 1e-15 && t < 1 ? t.toFixed(this._s).replace(/\.?0+$/, "") : String(t)),
    ...
    function pt(t, i, n) {
        ...
        var r, h;
        return [((r = t[i]), (h = vt(ft(t[n], t[s]), dt)), { nt: r.nt + h.nt, st: r.st + h.st }), ft(t[n], vt(ft(t[e], t[i]), dt))];
    }
    ...
    function Bt(t, i, n) {
        ...
        let l = r,
            a = h;
        return r > 0 && r < t.length && t[r].ot >= s && (l = r - 1), h > 0 && h < t.length && t[h - 1].ot <= e && (a = h + 1), { from: l, to: a };
    }
    class At {
        constructor(t, i, n) {
            (this.Bs = !0), (this.As = !0), (this.zs = !0), (this.Vs = []), (this.Es = null), (this.Is = t), (this.Ls = i), (this.Ns = n);
        }
        bt(t) {
            (this.Bs = !0), "data" === t && (this.As = !0), "options" === t && (this.zs = !0);
        }
        gt() {
            return this.Is.kt() ? (this.Fs(), null === this.Es ? null : this.Ws) : null;
        }
        js() {
        ...
        Fs() {
            this.As && (this.qs(), (this.As = !1)), this.zs && (this.js(), (this.zs = !1)), this.Bs && (this.Ys(), (this.Bs = !1));
        }
        Ys() {
            const t = this.Is.Dt(),
                i = this.Ls.St();
            ...
            const s = this.Is.Ct();
            null !== s && ((this.Es = Bt(this.Vs, n, this.Ns)), this.Zs(t, i, s.Ot), this.Gs());
        }
    }
    class zt extends At {
        constructor(t, i) {
    ...
    class Vt extends zt {
        constructor(t, i) {
            super(t, i), (this.Ws = new I()), (this.ee = new St()), (this.re = new Ct()), this.Ws.X([this.ee, this.re]);
        }
        ne(t, i, n) {
    ...
    class Et extends L {
        ...
        Z({ context: t, horizontalPixelRatio: i, verticalPixelRatio: n }) {
            if (null === this.Et || 0 === this.Et.Vn.length || null === this.Et.tt) return;
    ...
    class It extends At {
        ...
        be(t, i, n) {
            return { ot: t, we: i.Ot[0], ge: i.Ot[1], Me: i.Ot[2], xe: i.Ot[3], nt: NaN, ve: NaN, ce: NaN, de: NaN, pe: NaN };
        }
        qs() {
            const t = this.Is.$s();
            this.Vs = this.Is.Vn()
    ...
    class Lt extends It {
        ...
        Gs() {
            const t = this.Is.W();
            this.Ws.J({ Vn: this.Vs, he: this.Ls.St().he(), fe: t.openVisible, _e: t.thinBars, tt: this.Es });
        }
    }
    class Nt extends bt {
        constructor() {
    ...
    class Wt extends zt {
        constructor(t, i) {
            super(t, i), (this.Ws = new I()), (this.De = new Nt()), (this.Oe = new Ft()), this.Ws.X([this.De, this.Oe]);
        }
        ne(t, i, n) {
            return Object.assign(Object.assign({}, this.te(t, i)), n.Hs(t));
        }
        Gs() {
            ...
            const i = this.Is.W(),
                ...
                s = this.Ls.St().he();
            this.De.J({ it: this.Vs, et: i.lineWidth, Nt: i.lineStyle, ds: i.lineType, fs: n, vs: !1, tt: this.Es, cs: s }),
                this.Oe.J({
                    it: this.Vs,
                    et: i.lineWidth,
                    Nt: i.lineStyle,
    ...
    class jt extends L {
        ...
        Z(t) {
            ...
            const n = this.Et.Vn;
            this.Et.Be && this.Ae(t, n, this.Et.tt), this.Et._i && this.ze(t, n, this.Et.tt);
            const s = this.Ve(i);
        ...
        ze(t, i, n) {
            ...
            for (let t = n.from; t < n.to; t++) {
                ...
                if ((null !== a && ((o = Math.max(a + 1, o)), (o = Math.min(o, _))), this.Et.he * e > 2 * l)) U(s, o, u, _ - o + 1, c - u + 1, l);
                else {
                    const t = _ - o + 1;
    ...
    class Ht extends It {
        ...
        Gs() {
            const t = this.Is.W();
            this.Ws.J({ Vn: this.Vs, he: this.Ls.St().he(), Be: t.wickVisible, _i: t.borderVisible, tt: this.Es });
        }
    }
    class $t {
        constructor(t, i) {
    ...
    class Ut extends At {
        ...
        qs() {
            ...
            this.Vs = this.Is.Vn()
                .ie()
                .map((i) => Object.assign(Object.assign({ ot: i.se, nt: NaN }, t.Hs(i.se)), { je: i.He }));
        }
        Zs(t, i) {
            i.Js(this.Vs, A(this.Es));
        }
        Gs() {
            this.wn.update({ bars: this.Vs.map(qt), barSpacing: this.Ls.St().he(), visibleRange: this.Es }, this.Is.W());
        }
    }
    function qt(t) {
    ...
    class Yt extends L {
        ...
        Z({ context: t, horizontalPixelRatio: i, verticalPixelRatio: n }) {
            ...
            for (let i = this.Et.tt.from; i < this.Et.tt.to; i++) {
                ...
                let o, _;
                (t.fillStyle = h.ue),
                    a <= e ? ((o = a), (_ = r)) : ((o = e), (_ = a - Math.floor(s / 2) + s)),
                    t.fillRect(l.Os, o, l.ui - l.Os + 1, _ - o);
            }
        }
        Ue(t) {
            if (null === this.Et || 0 === this.Et.it.length || null === this.Et.tt) return void (this.$e = []);
    ...
    class Xt extends zt {
        ...
        Gs() {
            const t = { it: this.Vs, he: this.Ls.St().he(), tt: this.Es, qe: this.Is.Dt().Rt(this.Is.W().base, f(this.Is.Ct()).Ot) };
            this.Ws.J(t);
        }
    }
    class Kt extends zt {
    ...
    class Gt {
        ...
        nr(t, i, n) {
            ...
            return (
                t.restore(), (0 === r.width && i.length) || (this.Qe.set(e, { sr: r, er: this.Ze }), (this.Je[this.Ze] = e), this.Ke++, this.Ze++), r
            );
        }
    }
    class Jt {
    ...
    class Qt {
        constructor(t, i, n) {
            (this._r = t), (this.lr = new Gt(50)), (this.ur = i), (this.F = n), (this.j = -1), (this.Wt = new Jt(this.lr));
        }
        gt() {
            ...
            const s = this.F.mr();
            return s.P !== this.j && ((this.j = s.P), this.lr.ir()), this.Wt.ar(this._r.Vi(), s, n), this.Wt;
        }
    }
    class ti extends L {
        constructor() {
    ...
    class ii {
        ...
        gt() {
            return this.Is.kt() ? (this.ft && (this.yr(), (this.ft = !1)), this.Sr) : null;
        }
    }
    class ni extends ii {
        constructor(t) {
    ...
    function hi(t, i) {
        ...
        return { Pr: ri(i, e, s.zr, s.Vr), Rr: ri(i, e, s.Er, s.Ir), ht: ((r = e), (h = s.Br), (l = s.Ar), h + (l - h) * r) };
        var r, h, l;
    }
    class li {
        constructor(t) {
            (this.Wt = new si()), (this.ft = !0), (this.Lr = !0), (this.Nr = performance.now()), (this.Fr = this.Nr - 1), (this.Wr = t);
        }
        jr() {
        ...
        gt() {
            return this.ft ? (this.Mt(), (this.ft = !1), (this.Lr = !1)) : this.Lr && (this.qr(), (this.Lr = !1)), this.Wt;
        }
        Mt() {
            this.Wt.J(null);
    ...
    class pi extends L {
        constructor() {
            super(...arguments), (this.Et = null), (this.lr = new Gt()), (this.j = -1), (this.H = ""), (this.Jr = "");
        }
        J(t) {
            this.Et = t;
        }
        ar(t, i) {
            (this.j === t && this.H === i) || ((this.j = t), (this.H = i), (this.Jr = V(t, i)), this.lr.ir());
        }
        br(t, i) {
        ...
        Z({ context: t, horizontalPixelRatio: i, verticalPixelRatio: n }, s, e) {
            if (null !== this.Et && null !== this.Et.tt) {
                ...
                for (let s = this.Et.tt.from; s < this.Et.tt.to; s++) {
                    ...
                    void 0 !== e.Zt && ((e.Zt.Hi = this.lr.xi(t, e.Zt.th)), (e.Zt.zt = this.j), (e.Zt.nt = e.nt - e.Zt.Hi / 2)), mi(e, t, i, n);
                }
            }
        }
    }
                ...
                switch (t.ih) {
                    ...
                    case "circle":
                        return void (function (t, i, n) {
                            ...
                            t.beginPath(), t.arc(i.nt, i.st, s * i.Gr, 0, 2 * Math.PI, !1), t.fill();
                        })(i, n, t.Ks);
                    case "square":
                        return void (function (t, i, n) {
                            const s = oi("square", n),
    ...
    function wi(t, i, n, s, e, r, h, l, a) {
        ...
        switch (((t.Ks = d), i.position)) {
            case "inBar":
                return (t.st = h.Rt(o, a)), void (void 0 !== t.Zt && (t.Zt.st = t.st + f + r + 0.6 * e));
            case "aboveBar":
                return (t.st = h.Rt(_, a) - f - s.nh), void 0 !== t.Zt && ((t.Zt.st = t.st - f - 0.6 * e), (s.nh += 1.2 * e)), void (s.nh += d + r);
            case "belowBar":
                return (
                    (t.st = h.Rt(u, a) + f + s.sh), void 0 !== t.Zt && ((t.Zt.st = t.st + f + r + 0.6 * e), (s.sh += 1.2 * e)), void (s.sh += d + r)
                );
        }
        i.position;
    }
    class gi {
        ...
        bt(t) {
            (this.ft = !0), (this.rh = !0), "data" === t && ((this.eh = !0), (this.ah = null));
        }
        gt(t) {
            ...
            if (this.rh) {
                if (this.Wr.uh().length > 0) {
                    const t = this.$i.St().he(),
                        ...
                        n = 1.5 * _i(t) + 2 * i,
                        s = this.dh();
                    this.hh = { above: ci(n, s.aboveBar, s.inBar), below: ci(n, s.belowBar, s.inBar) };
                } else this.hh = null;
                this.rh = !1;
            }
            return this.hh;
        ...
        dh() {
            return (
                null === this.ah &&
                    (this.ah = this.Wr.uh().reduce((t, i) => (t[i.position] || (t[i.position] = !0), t), { inBar: !1, aboveBar: !1, belowBar: !1 })),
                this.ah
            );
        }
        oh() {
            const t = this.Wr.Dt(),
                ...
                n = this.Wr.uh();
            this.eh &&
                ((this.Et.it = n.map((t) => ({ ot: t.time, nt: 0, st: 0, Ks: 0, ih: t.shape, O: t.color, Qr: t.Qr, wr: t.id, Zt: void 0 }))),
                (this.eh = !1));
            ...
            for (let e = this.Et.tt.from; e < this.Et.tt.to; e++) {
                ...
                (_.nt = i.Vt(o.time)), void 0 !== o.text && o.text.length > 0 && (_.Zt = { th: o.text, nt: 0, st: 0, Hi: 0, zt: 0 });
    ...
    class Mi extends ii {
        ...
        yr() {
            ...
            n.Xr || ((t.kt = !0), (t.st = n.yi), (t.O = this.Is.ph(n.O)), (t.et = i.priceLineWidth), (t.Nt = i.priceLineStyle));
        }
    }
    class xi extends G {
        constructor(t) {
        ...
        Ei(t, i, n) {
            ...
            const e = s.W(),
                ...
                a = s.Yr(!1);
            if (a.Xr) return;
            r && ((t.Zt = this.bh(a, r, l)), (t.kt = 0 !== t.Zt.length)), (h || l) && ((i.Zt = this.wh(a, r, h, l)), (i.kt = i.Zt.length > 0));
            const o = s.ph(a.O),
                _ = y(o);
            (n.t = _.t), (n.yi = a.yi), (i.Bt = s.$t().At(a.yi / s.Dt().zt())), (t.Bt = o), (t.O = _.i), (i.O = _.i);
        }
        wh(t, i, n, s) {
            let e = "";
            const r = this.jt.mh();
            return n && 0 !== r.length && (e += `${r} `), i && s && (e += this.jt.Dt().gh() ? t.Mh : t.xh), e.trim();
        }
        bh(t, i, n) {
    ...
    class ki {
        ...
        Bh() {
            return null === this.zh ? null : { priceRange: this.zh.Bh(), margins: this.Vh || void 0 };
        }
        static Ah(t) {
    ...
    class Ci extends ii {
        ...
        yr() {
            ...
            const n = this.Lh.Nh();
            null !== n && ((t.kt = !0), (t.st = n), (t.O = i.color), (t.et = i.lineWidth), (t.Nt = i.lineStyle), (t.wr = this.Lh.W().id));
        }
    }
    class Ti extends G {
        constructor(t, i) {
        ...
        Ei(t, i, n) {
            ...
            const l = this.Lh.Nh();
            if (null === l) return;
            r && ((i.Zt = s.title), (i.kt = !0)), (i.Bt = h.$t().At(l / h.Dt().zt())), (t.Zt = this.Fh(s.price)), (t.kt = !0);
    ...
    class Pi {
        constructor(t, i) {
            (this.Wr = t), (this.cn = i), (this.Wh = new Ci(t, this)), (this._r = new Ti(t, this)), (this.jh = new Qt(this._r, t, t.$t()));
        }
        Hh(t) {
    ...
    const Di = {
        ...
        Line: (t, i, n, s) => {
            var e, r;
            const h = f(t(n, s));
            return { ue: null !== (e = h.O) && void 0 !== e ? e : i.color, lt: null !== (r = h.O) && void 0 !== r ? r : i.color };
        },
        Histogram: (t, i, n, s) => {
            var e;
            return { ue: null !== (e = f(t(n, s)).O) && void 0 !== e ? e : i.color };
    ...
    class Oi {
        constructor(t) {
            (this.Kh = (t, i) => (void 0 !== i ? i.Ot : this.Wr.Vn().Zh(t))), (this.Wr = t), (this.Gh = Di[t.Jh()]);
        }
        Hs(t, i) {
    ...
    class zi {
        ...
        vl(t, i, n) {
            ...
            for (let e = t; e < i; e++) {
                ...
                Number.isNaN(t) || (null === s ? (s = { pl: t, ml: t }) : (t < s.pl && (s.pl = t), t > s.ml && (s.ml = t)));
            }
            return s;
        }
        ol(t, i, n) {
    ...
    class Ni {
        ...
        gt() {
            return this.Wt.J(Object.assign({ Hi: this.yl.Hi() }, Li(this.Sl))), this.Wt;
        }
    }
    class Fi extends G {
        constructor(t, i) {
        ...
        Ei(t, i, n) {
            ...
            (n.wi = e), (n.gi = e), (n.yi = s.yi), (n.Si = s.Si), (t.Zt = s.Zt), (t.kt = s.kt), (t.hi = s.hi);
        }
    }
    class Wi {
        constructor(t, i) {
            (this.kl = null), (this.Cl = null), (this.Tl = null), (this.Pl = null), (this.Rl = null), (this.Dl = t), (this.Wr = i);
        }
        Ol() {
            return this.Dl;
        }
        ...
        Pn() {
            ...
            if ((null === (s = this.kl) || void 0 === s ? void 0 : s.gl) === e) return this.kl.Ml;
        ...
        Qi() {
            ...
            if ((null === (s = this.Cl) || void 0 === s ? void 0 : s.gl) === e) return this.Cl.Ml;
        ...
        Rn() {
            ...
            if ((null === (s = this.Tl) || void 0 === s ? void 0 : s.gl) === e) return this.Tl.Ml;
            const r = this.Wr.Dt(),
        ...
        Bl() {
            ...
            if ((null === (s = this.Pl) || void 0 === s ? void 0 : s.gl) === e) return this.Pl.Ml;
            const r = e.map((t) => new Ii(t));
        ...
        Al() {
            ...
            if ((null === (s = this.Rl) || void 0 === s ? void 0 : s.gl) === e) return this.Rl.Ml;
            const r = e.map((t) => new Ii(t));
    ...
    class qi extends Ri {
        ...
        Yr(t) {
            ...
            const l = r.Ot[3],
                a = this.$s().Hs(h, { Ot: r }),
                o = n.Rt(l, e.Ot);
            return { Xr: !1, _t: l, Zt: n.Fi(l, e.Ot), Mh: n.ql(l), xh: n.Yl(l, e.Ot), O: a.ue, yi: o, se: h };
        }
        $s() {
        ...
        ia(t) {
            ...
            this.dn.bt("data"), this.$t().ta(i), this.$t().Zl(this), this.$t().Gl(), this.$t().$h();
        }
        na() {
            return this.Nl;
        }
        ...
        On() {
            ...
            this.Wh.bt(), this.El.bt(), null === (t = this.Il) || void 0 === t || t.bt(), this.jl.forEach((t) => t.On());
        }
        Dt() {
            return f(super.Dt());
        }
        yt(t) {
            ...
            const i = this.Et.Zh(t);
            if (null === i) return null;
            return { _t: i.Ot[3], ht: this.wa(), Bt: this.ga(), Pt: this.Ma(), Tt: this.xa(t) };
        }
        mh() {
    ...
    class an {
        ...
        Xa(t, i, n) {
            ...
            if ((e <= s + 1e-14 && (e = s), (e = Math.max(1, e)), this.Ya.length > 0 && ((l = e), (a = 1), (o = 1e-14), Math.abs(l - a) < o)))
                for (r = 0, h = this.Ya[0]; gt(e, n * h, 1e-14) && e > s + 1e-14; ) (e /= h), (h = this.Ya[++r % this.Ya.length]);
            var l, a, o;
            return e;
        }
    }
    class on {
        constructor(t, i, n, s) {
            (this.Ka = []), (this.Ii = t), (this.Ua = i), (this.Za = n), (this.Ga = s);
        }
        Xa(t, i) {
        ...
        Qa() {
            ...
            for (let n = a - u; n > o; n -= _) {
                ...
                (null !== d && Math.abs(s - d) < this.Ja()) ||
                    s < h ||
                    s > l ||
                    (f < this.Ka.length ? ((this.Ka[f].Ia = s), (this.Ka[f].no = t.so(n))) : this.Ka.push({ Ia: s, no: t.so(n) }),
                    f++,
                    (d = s),
    ...
    class fn {
        ...
        Hh(t) {
            if ((C(this.cn, t), this.Pa(), void 0 !== t.mode && this.Po({ kr: t.mode }), void 0 !== t.scaleMargins)) {
        ...
        kr() {
            return { Wn: this.cn.autoScale, Bo: this.cn.invertScale, kr: this.cn.mode };
        }
        Po(t) {
            const i = this.kr();
            let n = null;
            void 0 !== t.Wn && (this.cn.autoScale = t.Wn),
                void 0 !== t.kr && ((this.cn.mode = t.kr), (2 !== t.kr && 3 !== t.kr) || (this.cn.autoScale = !0), (this.ao.oo = !1)),
                1 === i.kr &&
                    t.kr !== i.kr &&
                    (!(function (t, i) {
                        if (null === t) return !1;
                ...
                1 === t.kr && t.kr !== i.kr && ((n = rn(this.zh, this.Mo)), null !== n && this.Ao(n));
            const s = i.kr !== this.cn.mode;
            s && (2 === i.kr || this.gh()) && this.Pa(),
                s && (3 === i.kr || this.Oo()) && this.Pa(),
                void 0 !== t.Bo && i.Bo !== t.Bo && ((this.cn.invertScale = t.Bo), this.zo()),
                this.fo.m(i, this.kr());
        }
        Vo() {
            return this.fo;
        ...
        Ao(t, i) {
            const n = this.zh;
            (i || (null === n && null !== t) || (null !== n && !n.kh(t))) && ((this.mo = null), (this.zh = t));
        }
        Ni() {
        ...
        Rt(t, i) {
            return this.gh() ? (t = Ji(t, i)) : this.Oo() && (t = tn(t, i)), this.To(t, i);
        }
        Qs(t, i, n) {
            this.Fo();
            const s = this.No(),
        ...
        Yo(t) {
            ...
            this.vo.splice(i, 1), 0 === this.vo.length && (this.Po({ Wn: !0 }), this.Ao(null)), this.Pa(), this.qo();
        }
        Ct() {
            let t = null;
        ...
        Zo(t) {
            this.gh() ||
                this.Oo() ||
                (null === this.bo && null === this.lo && (this.Ni() || ((this.bo = this.ro - t), (this.lo = f(this.Eh()).Ch()))));
        }
        Go(t) {
        ...
        Qo(t) {
            this.Do() || (null === this.wo && null === this.lo && (this.Ni() || ((this.wo = t), (this.lo = f(this.Eh()).Ch()))));
        }
        t_(t) {
            if (this.Do()) return;
        ...
        Pa() {
            ...
            null !== t && (i = Math.round(1 / t.pa())),
                (this.ba = dn),
                this.gh() ? ((this.ba = cn), (i = 100)) : this.Oo() ? ((this.ba = new ot(100, 1)), (i = 100)) : null !== t && (this.ba = t.ma()),
        ...
        h_() {
            ...
            if (((s === this.uo && e === this.co) || ((this.uo = s), (this.co = e), (this.mo = null), this.Ro()), null !== i)) {
                if (i.Th() === i.Ph()) {
                    const t = this.s_(),
                        n = 5 * (null === t || this.gh() || this.Oo() ? 1 : t.pa());
                    this.eo() && (i = hn(i, this.Mo)), (i = new yi(i.Th() - n, i.Ph() + n)), this.eo() && (i = rn(i, this.Mo));
                }
                if (this.eo()) {
                ...
                this.Ao(i);
            } else null === this.zh && (this.Ao(new yi(-0.5, 0.5)), (this.Mo = ln(null)));
            var r, h;
            this.ao.oo = !0;
        }
        jo() {
    ...
    class vn {
        ...
        Yo(t) {
            const i = this.vo.indexOf(t);
            c(-1 !== i, "removeDataSource: invalid data source"), this.vo.splice(i, 1);
            const n = f(t.Dt()).Ta();
            if (this.a_.has(n)) {
            ...
            const s = t.Dt();
            s && s.Ba().indexOf(t) >= 0 && s.Yo(t), null !== s && (s.qo(), this.T_(s)), (this.po = null);
        }
        pr(t) {
        ...
        C_(t, i, n) {
            let s = this.b_(i);
            if ((null === s && (s = this.f_(i, this.$i.W().overlayPriceScales)), this.vo.push(t), !rt(i))) {
    ...
    class pn {
        constructor(t, i, n = 50) {
            (this.Ke = 0), (this.Ze = 1), (this.Ge = 1), (this.Qe = new Map()), (this.Je = new Map()), (this.H_ = t), (this.U_ = i), (this.tr = n);
        }
        q_(t) {
            const i = t.time,
            ...
            const e = this.H_(t);
            return this.Qe.set(n, { Y_: e, er: this.Ze }), this.Je.set(this.Ze, n), this.Ke++, this.Ze++, e;
        }
    }
    class mn {
        constructor(t, i) {
        ...
        tu(t, i) {
            ...
            for (let n = i; n < t.length; ++n) {
                ...
                void 0 === s && ((s = []), this.G_.set(i.timeWeight, s)),
                    s.push({ index: n, time: i.time, weight: i.timeWeight, originalTime: i.originalTime });
            }
        }
        nu(t, i) {
    ...
    class xn {
        ...
        Ou(t) {
            const i = Math.round(t.from),
                ...
                s = f(this.Bu()),
                e = f(this.Au());
            return { from: f(this.Ui(Math.max(s, i))), to: f(this.Ui(Math.min(e, n))) };
        }
        zu(t) {
        ...
        x_(t) {
            ...
            const i = this.Ru(),
                n = this.o_;
            if (((this.o_ = t), (this.fu = !0), this.cn.lockVisibleTimeRangeOnResize && 0 !== n)) {
                const i = (this.xu * t) / n;
                this.xu = i;
            }
        ...
        ja() {
            ...
            for (const t of h) {
                ...
                let n;
                c < this.gu.length
                    ? ((n = this.gu[c]), (n.coord = this.Vt(t.index)), (n.label = this.$u(t)), (n.weight = t.weight))
                    : ((n = { needAlignCoordinate: !1, coord: this.Vt(t.index), label: this.$u(t), weight: t.weight }), this.gu.push(n)),
        ...
        Yu(t, i) {
            const n = this.Nu(t),
                s = this.he(),
                e = s + i * (s / 10);
            this.Gn(e), this.cn.rightBarStaysOnScroll || this.Jn(this.ju() + (n - this.Nu(t)));
        }
        Zo(t) {
            this.wo && this.i_(), null === this.bo && null === this.bu && (this.Ni() || ((this.bo = t), this.Xu()));
        }
        Go(t) {
        ...
        Qo(t) {
            null === this.wo && null === this.bu && (this.Ni() || ((this.wo = t), this.Xu()));
        }
        t_(t) {
            if (null === this.wo) return;
        ...
        ec(t) {
            const i = t.Z_();
            this.Wu(this.o_ / i), (this.Mu = t.ui() - this.Iu()), this.Eu(), (this.fu = !0), this.$i.Fu(), this.$i.$h();
        }
        rc() {
            const t = this.Bu(),
                i = this.Au();
        ...
        $u(t) {
            ...
            return void 0 === i && ((i = new pn((t) => this.dc(t), this.U_)), this.cu.set(t.weight, i)), i.q_(t);
        }
        dc(t) {
        ...
        oc(t) {
            const i = this.du;
            (this.du = t), bn(i.hu(), this.du.hu()) || this.vu.m(), bn(i.lu(), this.du.lu()) || this.pu.m(), this.ac();
        }
        ac() {
            this.wu = null;
        }
    ...
    class kn {
        constructor(t) {
            (this.ft = !0), (this.Ft = { kt: !1, O: "", mc: [], gc: "center", Mc: "center" }), (this.Wt = new yn(this.Ft)), (this.jt = t);
        }
        bt() {
            this.ft = !0;
        }
        ...
        Mt() {
            ...
            (i.kt = t.visible),
                i.kt &&
                    ...
                    (i.Mc = t.horzAlign),
                    (i.gc = t.vertAlign),
                    (i.mc = [{ Zt: t.text, R: V(t.fontSize, t.fontFamily, t.fontStyle), wc: 1.2 * t.fontSize, xc: 0, Yu: 0 }]));
        }
    }
    class Cn extends nt {
        constructor(t, i) {
    ...
    class Bn {
        ...
        x_(t) {
            (this.o_ = t), this.yl.x_(this.o_), this.yc.forEach((i) => i.x_(t)), this.Fu();
        }
        zc(t) {
        ...
        fd(t) {
            const i = this.cr(t),
                n = this.kc.indexOf(t);
            c(-1 !== n, "Series not found"), this.kc.splice(n, 1), f(i).Yo(t), t.S && t.S();
        }
        Xl(t, i) {
            const n = f(this.cr(t));
            n.Yo(t);
        ...
        At(t) {
            const i = this.Ic,
                n = this.Vc;
            if (i === n) return i;
            if (((t = Math.max(0, Math.min(100, Math.round(100 * t)))), null === this.Rc || this.Rc.Ts !== n || this.Rc.Ps !== i))
    ...
    function En(t, i, n) {
        return i
            ...
            .replace(/MMMM/g, ((t, i) => new Date(t.getUTCFullYear(), t.getUTCMonth(), 1).toLocaleString(i, { month: "long" }))(t, n))
            .replace(/MMM/g, ((t, i) => new Date(t.getUTCFullYear(), t.getUTCMonth(), 1).toLocaleString(i, { month: "short" }))(t, n))
    ...
    class Fn {
        constructor(t = {}) {
            ...
            (this.Cd = new In(i.xd, i.kd)), (this.Td = new Ln(i.Sd)), (this.Pd = i.yd);
        }
        q_(t) {
    ...
    function Un(t, i) {
        ...
        for (let n = Hn.length - 1; n >= 0; --n) if (Math.floor(i.getTime() / Hn[n].Rd) !== Math.floor(t.getTime() / Hn[n].Rd)) return Hn[n].Dd;
        return 0;
    }
    function qn(t) {
        let i = t;
        if ((R(t) && (i = Xn(t)), !An(i))) throw new Error("time must be of type BusinessDay");
    ...
    class Zn {
        ...
        updateFormatter(t) {
            ...
            this.cn.timeScale.timeVisible
                ? (this.Ad = new Fn({ xd: i, Sd: this.cn.timeScale.secondsVisible ? "%h:%m:%s" : "%h:%m", yd: "   ", kd: t.locale }))
        ...
        fillWeightsForPoints(t, i) {
            !(function (t, i = 0) {
                ...
                for (let r = i; r < t.length; ++r) {
                    ...
                    null !== s && (i.timeWeight = Un(h, s)), (e += i.time.Od - (n || i.time.Od)), (n = i.time.Od), (s = h);
                }
                if (0 === i && t.length > 1) {
    ...
    var ts = (function () {
        function t(t, i, n) {
            ...
            (this._canvasElement = null),
                ...
                (this._canvasElementClientSize = Gn({ width: this._canvasElement.clientWidth, height: this._canvasElement.clientHeight })),
        ...
        return (
            ...
            (t.prototype._suggestNewBitmapSize = function (t) {
                ...
                (null === i && null === s) ||
                    ...
                    ((this._suggestedBitmapSize = s), this._emitSuggestedBitmapSizeChanged(i, s));
            }),
            ...
            (t.prototype._invalidateBitmapSize = function () {
                ...
                if (null !== this._canvasElement) {
                    ...
                    if (null !== n) {
                        var s =
                                null !== (i = null === (t = this._devicePixelRatioObservable) || void 0 === t ? void 0 : t.value) && void 0 !== i
                                    ? i
                                    : n.devicePixelRatio,
                            ...
                            r =
                                void 0 !== e[0]
                                    ...
                                    : Gn({ width: this._canvasElementClientSize.width * s, height: this._canvasElementClientSize.height * s });
    ...
    class _s {
        ...
        qd(t, i) {
            ...
            (this.Nd = this.Ld), (this.Ld = this.Id), (this.Id = this.Ed), (this.Ed = { ot: i, Vd: t });
        }
        Dr(t, i) {
    ...
    class ms {
        constructor(t, i, n) {
            (this.Xd = 0),
                (this.Kd = null),
                (this.Zd = { nt: Number.NEGATIVE_INFINITY, st: Number.POSITIVE_INFINITY }),
                (this.Gd = 0),
                (this.Jd = null),
                (this.Qd = { nt: Number.NEGATIVE_INFINITY, st: Number.POSITIVE_INFINITY }),
                (this.tf = null),
                (this.if = !1),
                (this.nf = null),
                (this.sf = null),
            ...
            if (this.ef || !(r < 5)) {
                if (!this.ef) {
                    const t = 0.5 * s,
                        i = e >= t && !this.cn.qf(),
                        n = t > e && !this.cn.Yf();
                    i || n || (this.mf = !0), (this.ef = !0), (this.hf = !0), this.Lf(), this.Bf();
                }
                if (!this.mf) {
                    const n = this.Cf(t, i);
        ...
        Gf(t) {
            ...
            (this.gf = null), (this.wf = Ms(t)), this.Lf(), (this.sf = null), this.df && (this.df(), (this.df = null));
            const n = this.Cf(t, i);
            ...
            0 === this.Gd && ws(t), 0 === t.touches.length && this.if && ((this.if = !1), ws(t));
        }
        Sf(t) {
            if (0 !== t.button) return;
            const i = this.Cf(t);
            if (((this.nf = null), (this.bf = !1), this.cf && (this.cf(), (this.cf = null)), rs())) {
        ...
        nv(t) {
            ...
            (this.hf = !1), (this.ef = !1), (this.mf = !1), (this.sf = gs(i)), this.df && (this.df(), (this.df = null));
            {
            ...
            const s = this.Cf(t, i);
            this.Rf(s, this.Of.ev), this.Jd || ((this.Gd = 0), (this.Jd = setTimeout(this.Bf.bind(this), 500)), (this.Qd = gs(i)));
        }
        rv(t) {
            if (0 !== t.button) return;
            const i = this.Ef.ownerDocument.documentElement;
            rs() && i.addEventListener("mouseleave", this.xf), (this.rf = !1), (this.nf = gs(t)), this.cf && (this.cf(), (this.cf = null));
            {
            ...
            const n = this.Cf(t);
            this.Af(n, this.Of.hv), this.Kd || ((this.Xd = 0), (this.Kd = setTimeout(this.Vf.bind(this), 500)), (this.Zd = gs(t)));
        }
        If() {
            this.Ef.addEventListener("mouseenter", this.Nf.bind(this)), this.Ef.addEventListener("touchcancel", this.Lf.bind(this));
            {
                const t = this.Ef.ownerDocument,
                    i = (t) => {
                        this.Of.lv &&
                            ((t.composed && this.Ef.contains(t.composedPath()[0])) || (t.target && this.Ef.contains(t.target)) || this.Of.lv());
                    };
                (this.af = () => {
            ...
            hs() &&
                ...
                this.Ef.addEventListener("touchstart", this.nv.bind(this), { passive: !0 }),
                ps(this.Ef),
        ...
        ov() {
            (void 0 === this.Of._v && void 0 === this.Of.uv && void 0 === this.Of.cv) ||
                (this.Ef.addEventListener("touchstart", (t) => this.dv(t.touches), { passive: !0 }),
        ...
        dv(t) {
            1 === t.length && (this.pf = !1), 2 !== t.length || this.pf || this.if ? this.fv() : this.vv(t);
        }
        vv(t) {
            const i = this.Ef.getBoundingClientRect() || { left: 0, top: 0 };
            (this.ff = { nt: (t[0].clientX - i.left + (t[1].clientX - i.left)) / 2, st: (t[0].clientY - i.top + (t[1].clientY - i.top)) / 2 }),
                (this.vf = bs(t[0], t[1])),
    ...
    function ks(t, i) {
        return (n) => {
            var s, e, r, h;
            return (null !== (e = null === (s = n.Dt()) || void 0 === s ? void 0 : s.Ta()) && void 0 !== e ? e : "") !== i
                ? []
                : null !== (h = null === (r = n.ca) || void 0 === r ? void 0 : r.call(n, t)) && void 0 !== h
                ? h
                : [];
        };
    }
    function Cs(t, i, n, s) {
        ...
        let e = 0;
        const r = t[0].zt(s, !0);
        let h = 1 === i ? n / 2 - (t[0].Oi() - r / 2) : t[0].Oi() - r / 2 - n / 2;
        h = Math.max(0, h);
        for (let r = 1; r < t.length; r++) {
            ...
            if (1 === i ? _ > u - o : _ < u + o) {
                ...
                if ((1 === i ? r < 0 : r > n) && h > 0) {
                    const s = 1 === i ? -1 - r : r - n,
                        l = Math.min(s, h);
                    for (let n = e; n < t.length; n++) t[n].Bi(t[n].Oi() + i * l);
                    h -= l;
                }
    ...
    class Ts {
        constructor(t, i, n, s) {
            ...
            this.Xv = new ms(this.Fv.canvasElement, h, { qf: () => !this.cn.handleScroll.vertTouchDrag, Yf: () => !0 });
        }
        S() {
            this.Xv.S(),
        ...
        Gv() {
            ...
            n.save();
            const s = this.Ii.ja();
            (n.font = this.Jv()), s.length > 0 && (t = Math.max(this.Pv.xi(n, s[0].no), this.Pv.xi(n, s[s.length - 1].no)));
            const e = this.Qv();
            ...
            if (null !== r && null !== this.Cv) {
                ...
                t = Math.max(
                    t,
                    this.Pv.xi(n, this.Ii.Fi(Math.floor(Math.min(i, s)) + 0.11111111111111, r)),
                    this.Pv.xi(n, this.Ii.Fi(Math.ceil(Math.max(i, s)) - 0.11111111111111, r))
                );
            }
            n.restore();
            const h = t || 34;
        ...
        Gi(t) {
            this.Ii !== t && (null !== this.Ii && this.Ii.Ko().p(this), (this.Ii = t), t.Ko().l(this.do.bind(this), this));
        }
        Dt() {
            return this.Ii;
        }
        ...
        Wv(t) {
            if (null === this.Ii || this.Ii.Ni() || !this.cn.handleScale.axisPressedMouseMove.price) return;
            const i = this.tn.Bv().$t(),
                n = this.tn.np();
            (this.Tv = !0), i.D_(n, this.Ii, t.localY);
        }
        jv(t) {
            if (null === this.Ii || !this.cn.handleScale.axisPressedMouseMove.price) return;
            const i = this.tn.Bv().$t(),
                n = this.tn.np(),
                s = this.Ii;
            i.O_(n, s, t.localY);
        ...
        ze({ context: t, bitmapSize: i, horizontalPixelRatio: n }) {
            if (null === this.Cv || null === this.Ii || !this.Ii.W().borderVisible) return;
        ...
        lp(t) {
            ...
            n.borderVisible &&
                n.ticksVisible &&
                t.useBitmapCoordinateSpace(({ context: t, horizontalPixelRatio: r, verticalPixelRatio: h }) => {
                    t.fillStyle = n.borderColor;
                    const l = Math.max(1, Math.floor(h)),
                        a = Math.floor(0.5 * h),
                        o = Math.round(s.T * r);
                    t.beginPath();
                    for (const n of i) t.rect(Math.floor(e * r), Math.round(n.Ia * h) - a, o, l);
                    t.fill();
                }),
                t.useMediaCoordinateSpace(({ context: t }) => {
                    var r;
        ...
        dp(t, i, n) {
            ...
            for (const n of t) {
                const t = Math.floor(n.zt(i) / 2),
                    s = n.yi();
                s > -t && s < t && n.Bi(t), s > this.Cv.height - t && s < this.Cv.height + t && n.Bi(this.Cv.height - t);
            }
    ...
    class Bs {
        ...
        jf(t) {
            ...
            this.Lp(n, s, t);
            const e = this.br(n, s);
            this.Tp.Fp(null !== (i = null == e ? void 0 : e.kv) && void 0 !== i ? i : null), this.$i().Wc(e && { jc: e.jc, Sv: e.Sv });
        }
        iv(t) {
        ...
        ev(t) {
            ...
            const i = this.$i().Yc();
            null !== this.xp && i.kt() && ((this.yp = { x: i.Yt(), y: i.Xt() }), (this.xp = { x: t.localX, y: t.localY }));
        }
        Xf(t) {
        ...
        Jf(t) {
            0 === this.Bv().W().trackingMode.exitMode && (this.Sp = !0), this.Kp(), this.$p(t);
        }
        br(t, i) {
            const n = this.Cp;
            return null === n
                ...
                : (function (t, i, n) {
                      ...
                      for (const r of s) {
                          if (e && e.jc === r && "bottom" !== e.yv.zOrder && !e.yv.isBackground) return Ss(e);
        ...
        Zp(t, i) {
            f("left" === i ? this.fp : this.vp).tp(Gn({ width: t, height: this.Cv.height }));
        }
        Gp() {
            return this.Cv;
        }
        ...
        sp(t) {
            if (0 === t) return;
            if (null === this.Cp) return;
            if ((t > 1 && this.Jp(), null !== this.fp && this.fp.sp(t), null !== this.vp && this.vp.sp(t), 1 !== t)) {
                ...
                null !== t &&
                    ...
                    this.Cp && (this.Qp(t, Ps), this.tm(t), this.im(t), this.Qp(t, Rs), this.Qp(t, Ds)));
            }
            this.Fv.applySuggestedBitmapSize();
            const i = ss(this.Fv);
            null !== i &&
        ...
        im(t) {
            const i = this.$i().qc();
            this.hm(t, Rs, ds, i), this.hm(t, Rs, fs, i);
        }
        nm(t) {
        ...
        Vp() {
            ...
            i || null === this.fp || (this.Dp.removeChild(this.fp.Kv()), this.fp.S(), (this.fp = null)),
                n || null === this.vp || (this.Op.removeChild(this.vp.Kv()), this.vp.S(), (this.vp = null));
            const s = t.$t()._d();
            i && null === this.fp && ((this.fp = new Ts(this, t.W(), s, "left")), this.Dp.appendChild(this.fp.Kv())),
                n && null === this.vp && ((this.vp = new Ts(this, t.W(), s, "right")), this.Op.appendChild(this.vp.Kv()));
        }
        lm(t) {
        ...
        $p(t) {
            ...
            const i = this.$i(),
                n = this.np();
            if ((i.V_(n, n.vn()), (this.pp = null), (this.mp = !1), i.sd(), null !== this.kp)) {
                const t = performance.now(),
                    n = i.St();
        ...
        Hp(t) {
            ...
            const s = this.Tp.W(),
                e = s.handleScroll,
                r = s.kineticScroll;
            if ((!e.pressedMouseMove || t.bv) && ((!e.horzTouchDrag && !e.vertTouchDrag) || !t.bv)) return;
            const h = this.Cp.vn(),
                l = performance.now();
            if (
                (null !== this.pp || this.lm(t) || (this.pp = { x: t.clientX, y: t.clientY, Od: l, _m: t.localX, um: t.localY }),
                null !== this.pp && !this.mp && (this.pp.x !== t.clientX || this.pp.y !== t.clientY))
            ) {
                if ((t.bv && r.touch) || (!t.bv && r.mouse)) {
                    const t = n.he();
                    (this.kp = new _s(0.2 / t, 7 / t, 0.997, 15 / t)), this.kp.qd(n.ju(), this.pp.Od);
                } else this.kp = null;
    ...
    class As {
        ...
        S() {
            this.Nv.unsubscribeSuggestedBitmapSizeChanged(this.Ov), cs(this.Nv.canvasElement), this.Nv.dispose();
        }
        Kv() {
            return this.Lv;
        }
    ...
    class Ls {
        constructor(t, i) {
            ...
            (s.style.position = "absolute"),
                ...
                (this.Xv = new ms(this.Fv.canvasElement, this, { qf: () => !0, Yf: () => !this.Tp.W().handleScroll.horzTouchDrag }));
        }
        S() {
            this.Xv.S(),
        ...
        lv() {
            const t = this.Tp.$t();
            !t.St().Ni() && this.bm && ((this.bm = !1), this.Tp.W().handleScale.axisPressedMouseMove.time && t.rd());
        }
        Zf(t) {
            const i = this.Tp.$t();
        ...
        sp(t) {
            ...
            if (1 !== t) {
                ...
                null !== i &&
                    (i.useBitmapCoordinateSpace((t) => {
                        this.rp(t), this.ze(t), this.Bm(i, Is);
                    }),
                    this.lp(i),
                    this.Bm(i, Vs)),
        ...
        lp(t) {
            ...
            r.borderVisible &&
                r.ticksVisible &&
                t.useBitmapCoordinateSpace(({ context: t, horizontalPixelRatio: i, verticalPixelRatio: s }) => {
                ...
                t.useMediaCoordinateSpace(({ context: t }) => {
                    ...
                    (t.textAlign = "center"), (t.textBaseline = "middle"), (t.fillStyle = this.$()), (t.font = this.Jv());
                    for (const e of n)
                        if (e.weight < s) {
        ...
        Vm(t, i, n) {
            ...
            return r < 0 ? (i += Math.abs(0 - r)) : r + s > this.Cv.width && (i -= Math.abs(this.Cv.width - (r + s))), i;
        }
        Am(t, i) {
            const n = this.Dm();
        ...
        Dm() {
            null === this.k && (this.k = { C: 1, N: NaN, L: NaN, A: NaN, ji: NaN, T: 5, P: NaN, R: "", Wi: new Gt(), Om: 0 });
            const t = this.k,
                i = this.Jv();
            if (t.R !== i) {
                const n = this.j();
                (t.P = n), (t.R = i), (t.L = (3 * n) / 12), (t.A = (3 * n) / 12), (t.ji = (9 * n) / 12), (t.N = 0), (t.Om = (4 * n) / 12), t.Wi.ir();
            }
            return this.k;
        }
        cp(t) {
        ...
        ym() {
            const t = this.Tp.$t(),
                i = t.W();
            i.leftPriceScale.visible || null === this.vm || (this.Mm.removeChild(this.vm.Kv()), this.vm.S(), (this.vm = null)),
                i.rightPriceScale.visible || null === this.pm || (this.xm.removeChild(this.pm.Kv()), this.pm.S(), (this.pm = null));
            const n = { _d: this.Tp.$t()._d() },
                s = () => i.leftPriceScale.borderVisible && t.St().W().borderVisible,
                e = () => t.md();
            i.leftPriceScale.visible && null === this.vm && ((this.vm = new As("left", i, n, s, e)), this.Mm.appendChild(this.vm.Kv())),
                i.rightPriceScale.visible && null === this.pm && ((this.pm = new As("right", i, n, s, e)), this.xm.appendChild(this.pm.Kv()));
        }
    }
    const Ns =
        !!es &&
        ...
        !!es &&
        ((null === (Fs = null === navigator || void 0 === navigator ? void 0 : navigator.userAgentData) || void 0 === Fs ? void 0 : Fs.platform)
    ...
    class Ws {
        ...
        S() {
            this.Km(!1),
                ...
                this.$i.w_().p(this),
                this.$i.S();
            for (const t of this.Im) this.qm.removeChild(t.Kv()), t.Yp().p(this), t.Xp().p(this), t.S();
            (this.Im = []),
                f(this.Gm).S(),
        ...
        Fp(t) {
            (this.$m = t), this.$m ? this.fb().style.setProperty("cursor", t) : this.fb().style.removeProperty("cursor");
        }
        pb() {
            return this.$m;
        }
        ...
        ab(t) {
            ...
            if (this.cn.timeScale.visible) {
                ...
                if (null !== t) {
                    let e = 0;
                    this._b() && (r("left", e, n), (e = f(s.sm())._p().width)), this.Gm.up(t, e, n), (e += i.width), this.ub() && r("right", e, n);
                }
                n += i.height;
            }
        ...
        Km(t) {
            t ? this.gm.addEventListener("wheel", this.Ym, { passive: !1 }) : this.gm.removeEventListener("wheel", this.Ym);
        }
        wb(t) {
            switch (t.deltaMode) {
            ...
            3 === s && this.gb(),
                (3 !== s && 2 !== s) ||
                    ...
                    3 === (null === (n = this.Wm) || void 0 === n ? void 0 : n.jn()) &&
                        (this.Wm.ts(t), this.gb(), this.Mb(this.Wm), this.xb(this.Wm, i), (t = this.Wm), (this.Wm = null))),
                this.sp(t);
        }
        xb(t, i) {
        ...
        tb() {
            ...
            for (let s = n; s < i; s++) {
                ...
                i.Yp().l(this.Sb.bind(this), this), i.Xp().l(this.yb.bind(this), this), this.Im.push(i), this.qm.insertBefore(i.Kv(), this.Gm.Kv());
            }
            for (let n = 0; n < i; n++) {
                const i = t[n],
                    s = this.Im[n];
        ...
        kb(t, i, n) {
            ...
            return { Cb: r, se: null != t ? t : void 0, Tb: null != i ? i : void 0, Pb: l, Rb: e, Db: a, Ob: null != n ? n : void 0 };
        }
        Sb(t, i, n) {
    ...
    function Ks(t, i, n, s, e) {
        const r = d(e)(n),
            ...
            _ = n,
            { time: u, color: c } = _;
        return { se: i, ot: t, Ot: o, Cb: s, He: Hs(_, ["time", "color"]), O: c };
    }
    function Zs(t) {
        return void 0 !== t.Ot;
    }
    ...
    function Qs(t) {
        return { Candlestick: Js(Xs), Bar: Js(Ys), Area: Js(Us), Baseline: Js(qs), Histogram: Js($s), Line: Js($s), Custom: Js(Ks) }[t];
    }
    function te(t) {
        return { se: 0, Ab: new Map(), ha: t };
    }
    function ie(t, i) {
        if (void 0 !== t && 0 !== t.length) return { zb: i.key(t[0].ot), Vb: i.key(t[t.length - 1].ot) };
    }
    function ne(t) {
        let i;
        return (
    ...
    class se {
        constructor(t) {
            (this.Eb = new Map()), (this.Ib = new Map()), (this.Lb = new Map()), (this.Nb = []), (this.U_ = t);
        }
        S() {
        ...
        Fb(t, i) {
            ...
            if (0 !== i.length) {
                ...
                r = i.map((i, r) => {
                    const o = e(i.time),
                        _ = this.U_.key(o);
                    let u = this.Eb.get(_);
                    void 0 === u && ((u = te(o)), this.Eb.set(_, u), (s = !0));
            ...
            if (s) {
                const t = [];
                this.Eb.forEach((i) => {
                    t.push({ timeWeight: 0, time: i.ha, pointData: i, originalTime: ne(i.Ab) });
                }),
            ...
            return this.$b(
                ...
                (function (t, i, n) {
                    const s = ie(t, n),
                        e = ie(i, n);
                    if (void 0 !== s && void 0 !== e) return { Ql: s.Vb >= e.Vb && s.zb >= e.zb };
        ...
        Ub(t, i) {
            ...
            const s = this.U_.createConverterToInternalObj([i])(i.time),
                e = this.Lb.get(t);
            if (void 0 !== e && this.U_.key(s) < this.U_.key(e)) throw new Error(`Cannot update oldest data, last time=${e}, new time=${s}`);
            let r = this.Eb.get(this.U_.key(s));
            const h = void 0 === r;
            void 0 === r && ((r = te(s)), this.Eb.set(this.U_.key(s), r));
            const l = Qs(t.Jh()),
                a = t.ka(),
                o = t.Ca(),
            ...
            const c = { timeWeight: 0, time: r.ha, pointData: r, originalTime: ne(r.Ab) },
                d = Pt(this.Nb, this.U_.key(c.time), (t, i) => this.U_.key(t.time) < i);
            this.Nb.splice(d, 0, c);
            for (let t = d; t < this.Nb.length; ++t) ee(this.Nb[t].pointData, t);
        ...
        jb(t, i) {
            0 !== i.length ? (this.Ib.set(t, i.filter(Zs)), this.Lb.set(t, i[i.length - 1].ot)) : (this.Ib.delete(t), this.Lb.delete(t));
        }
        Wb() {
            for (const t of this.Nb) 0 === t.pointData.Ab.size && this.Eb.delete(this.U_.key(t.time));
        }
        Hb(t) {
            let i = -1;
            ...
            if ((-1 === i && this.Nb.length !== t.length && (i = Math.min(this.Nb.length, t.length)), -1 === i)) return -1;
    ...
    function oe(t) {
        const i = { open: t.Ot[0], high: t.Ot[1], low: t.Ot[2], close: t.Ot[3], time: t.Cb };
        return void 0 !== t.Bb && (i.customValues = t.Bb), i;
    }
    function _e(t) {
        const i = oe(t);
    ...
    const fe = {
            vertLine: { color: "#9598A1", width: 1, style: 3, visible: !0, labelVisible: !0, labelBackgroundColor: "#131722" },
            horzLine: { color: "#9598A1", width: 1, style: 3, visible: !0, labelVisible: !0, labelBackgroundColor: "#131722" },
            mode: 1,
        },
        ve = { vertLines: { color: "#D6DCDE", style: 0, visible: !0 }, horzLines: { color: "#D6DCDE", style: 0, visible: !0 } },
        pe = { background: { type: "solid", color: "#FFFFFF" }, textColor: "#191919", fontSize: 12, fontFamily: z },
        me = {
            autoScale: !0,
            mode: 0,
            invertScale: !1,
    ...
    function ge() {
        return {
            ...
            handleScale: { axisPressedMouseMove: { time: !0, price: !0 }, axisDoubleClickReset: { time: !0, price: !0 }, mouseWheel: !0, pinch: !0 },
    ...
    class ke {
        constructor(t, i, n, s, e) {
            (this.iw = new k()), (this.Is = t), (this.nw = i), (this.sw = n), (this.U_ = e), (this.ew = s);
        }
        S() {
            this.iw.S();
        }
        ...
        barsInLogicalRange(t) {
            ...
            const l = { barsBefore: null === s || s.se === r ? t.from - r : s.se - r, barsAfter: null === e || e.se === h ? h - t.to : h - e.se };
        ...
        attachPrimitive(t) {
            this.Is.Sa(t), t.attached && t.attached({ chart: this.ew, series: this, requestUpdate: () => this.Is.$t().Kl() });
        }
        detachPrimitive(t) {
    ...
    class Ce {
        ...
        S() {
            this.yl.tc().p(this), this.yl.nc().p(this), this.Gm.Tm().p(this), this.aw.S(), this.pu.S(), this.wm.S();
        }
        scrollPosition() {
            return this.yl.ju();
        }
        ...
        setVisibleRange(t) {
            const i = { from: this.U_.convertHorzItemToInternal(t.from), to: this.U_.convertHorzItemToInternal(t.to) },
                n = this.yl.zu(i);
            this.$i.vd(n);
        }
        ...
        setVisibleLogicalRange(t) {
            c(t.from <= t.to, "The from index cannot be after the to index."), this.$i.vd(t);
        }
        resetTimeScale() {
            this.$i.Zn();
        }
        ...
        options() {
            return Object.assign(Object.assign({}, O(this.yl.W())), { barSpacing: this.yl.he() });
        }
        ow() {
    ...
    class Re {
        constructor(t, i, n) {
            (this.cw = new Map()), (this.dw = new Map()), (this.fw = new k()), (this.pw = new k()), (this.mw = new k()), (this.bw = new se(i));
        ...
        xw(t) {
            const i = this.Jb.$t();
            i.od(t.St.Iu, t.St.Zb, t.St.Gb), t.Xb.forEach((t, i) => i.J(t.He, t.Kb)), i.Fu();
        }
        Sw(t) {
        ...
        ww(t) {
            ...
            return { time: t.Cb, logical: t.se, point: t.Tb, hoveredSeries: n, hoveredObjectId: t.Db, seriesData: i, sourceEvent: t.Ob };
        }
    }
    function De(t, i, n) {
        let s;
